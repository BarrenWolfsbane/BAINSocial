 ...
 * This is the base class for all GnuPG*.java Classes. DO NOT USE IT. It is not
...
public class GnuPGPeer {
     ...
     */
    protected void setInternalRepresentation(long ptr) { _internalRepresentation = ptr; } // note that this is a pointer to an address in the gnupg-for-java shared lib
    /**
     * DO NOT USE IT. This is only use from inside the library.
     */
    protected long getInternalRepresentation() { return _internalRepresentation; } // note that this is a pointer to an address in the gnupg-for-java shared lib
}
