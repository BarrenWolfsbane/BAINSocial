...
public class GnuPGKey extends GnuPGPeer {
     ...
     */
    protected GnuPGKey(long ptr) { setInternalRepresentation(ptr); } // note that this is a pointer to an address in the gnupg-for-java shared lib
    /**
     ...
     */
    protected GnuPGKey(GnuPGContext context, String fingerprint) { setInternalRepresentation(gpgmeGetKey(context.getInternalRepresentation(), fingerprint,false)); }
    /**
     ...
     */
    protected GnuPGKey(GnuPGContext context, String fingerprint, boolean secret_only) { setInternalRepresentation(gpgmeGetKey(context.getInternalRepresentation(), fingerprint, secret_only)); }
    /**
     * Get the Name of the default key/userid.
     */
    public String getName() { return gpgmeGetName(getInternalRepresentation()); }
    /**
     * Get the Email-Address of the default key/userid.
     */
    public String getEmail() { return gpgmeGetEmail(getInternalRepresentation()); }
    /**
     * Get the Key-ID of the default key/userid.
     */
    public String getKeyID() { return gpgmeGetKeyID(getInternalRepresentation()); }
    /**
     * Get the Fingerprint of the default key/userid.
     */
    public String getFingerprint() { return gpgmeGetFingerprint(getInternalRepresentation()); }
    /**
     * Get the Comment of the default key/userid.
     */
    public String getComment() { return gpgmeGetComment(getInternalRepresentation()); }
    /**
     * Get the User-ID of the default key/userid.
     */
    public String getUserID() { return gpgmeGetUserID(getInternalRepresentation()); }
    public boolean canEncrypt() { return gpgmeCanEncrypt(getInternalRepresentation()); }
    public boolean canSign() { return gpgmeCanSign(getInternalRepresentation()); }
    public boolean canCertify() { return gpgmeCanCertify(getInternalRepresentation()); }
    public boolean canAuthenticate() { return gpgmeCanAuthenticate(getInternalRepresentation()); }
    public boolean isRevoked() { return gpgmeIsRevoked(getInternalRepresentation()); }
    public boolean isExpired() { return gpgmeIsExpired(getInternalRepresentation()); }
    public boolean isDisabled() { return gpgmeIsDisabled(getInternalRepresentation()); }
    public boolean isInvalid() { return gpgmeIsInvalid(getInternalRepresentation()); }
    public boolean isQualified() { return gpgmeIsQualified(getInternalRepresentation()); }
    public boolean isSecret() { return gpgmeIsSecret(getInternalRepresentation()); }
    public boolean hasSecretKey() { return gpgmeHasSecretKey(getInternalRepresentation()); }
    /**
    ...
    public Iterator<GnuPGSignature> getSignatures() {
        ...
        while (sig != null) {
            if (siglist == null)  siglist = new ArrayList<GnuPGSignature>();
            siglist.add(sig);
            sig = sig.getNextSignature();
        }
        if (siglist == null) return null;
        else return siglist.listIterator();
    }
    /**
    ...
    private GnuPGSignature getSignature() {
        ...
        // note that this is a pointer to an address in the gnupg-for-java shared
        // lib
        long ptr = gpgmeGetSignature(getInternalRepresentation());
        if (ptr != 0)  result = new GnuPGSignature(ptr);
        return result;
    }
    /**
