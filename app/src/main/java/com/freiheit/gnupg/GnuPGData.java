...
public class GnuPGData extends GnuPGPeer {
     ...
     */
    protected GnuPGData() { setInternalRepresentation(gpgmeDataNew()); }
    /**
     ...
     * @throws IOException
     */
    protected GnuPGData(File file) throws IOException, GnuPGException { this(file, "r+"); }
    /**
     * Use the factory methods in GnuPGContext to create GnuPGData instances.
    ...
    protected GnuPGData(File file, String mode) throws IOException, GnuPGException {
        ...
        if (!file.canRead()) throw new IOException("Is a directory: " + file);
     ...
     */
    protected GnuPGData(String str) { this(str.getBytes()); }
    /**
     * Use the factory methods from GnuPGContext to create GnuPGData instances.
    ...
    public void read(InputStream in) throws IOException {
        if (in != null) gpgmeDataRead(getInternalRepresentation(), in);
    }
    /**
    ...
    public void write(OutputStream out) throws IOException {
        if (out != null) gpgmeDataWrite(getInternalRepresentation(), out);
    }
    /**
    ...
    public String toString() {
        ...
        } catch (IOException ioe) { result = ioe.getMessage(); }
        return result;
    }
    /**
    ...
    public int size() { return gpgmeSize(getInternalRepresentation()); }
