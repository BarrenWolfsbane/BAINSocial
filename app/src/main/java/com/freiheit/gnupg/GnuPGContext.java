...
public class GnuPGContext extends GnuPGPeer {
    ...
    static { System.loadLibrary("gnupg-for-java"); }
     ...
     */
    public String getRequiredVersion() { return _reqversion; }
    /**
     * Returns the used protocol of the crypto backend.
     * 
     * @return protocol
     */
    public int getProtocol() { return _protocol; }
    /**
     ...
     */
    public boolean isArmor() { return gpgmeGetArmor(getInternalRepresentation()); }
    /**
     ...
     *            binary
     */
    public void setArmor(boolean state) { gpgmeSetArmor(getInternalRepresentation(), state); }
    /**
     ...
     */
    public boolean isTextmode() { return gpgmeGetTextmode(getInternalRepresentation()); }
    /**
     ...
     */
    public boolean getTextmode() { return gpgmeGetTextmode(getInternalRepresentation()); }
    /**
     ...
     */
    public void setTextmode(boolean state) { gpgmeSetTextmode(getInternalRepresentation(), state); }
    private long[] getInternalRepresentationFromRecipients(GnuPGKey[] recipients) {
        ...
        for (int i = 0; i < recipients.length; i++) {
            if (recipients[i] != null) recipientsInternals[i] = recipients[i].getInternalRepresentation();
            else ; // FIXME: throw exception here? Just skip over it for now.
        }
        return recipientsInternals;
    }
    private boolean hasNoRecipients(GnuPGKey[] recipients) { return !(recipients != null && recipients.length > 0); }
    /**
    ...
    public GnuPGKey getKeyByFingerprint(String fingerprint) throws GnuPGException {
        if (fingerprint == null || fingerprint.length() < 1) return null;
        else return new GnuPGKey(this, fingerprint, false);
    }
    /**
     ...
     * @see com.freiheit.gnupg.GnuPGKey
     */
    public GnuPGKey getSecretKeyByFingerprint(String fingerprint) throws GnuPGException {
        if (fingerprint == null || fingerprint.length() < 1) return null;
        else return new GnuPGKey(this, fingerprint, true);
    }
    /**
    ...
    public GnuPGData createDataObject(File f) throws GnuPGException, IOException {
        if (f != null && f.exists() && !f.isDirectory() && f.canRead())  return new GnuPGData(f);
        return null;
    }
    /**
    ...
    public GnuPGData createDataObject(String data) throws GnuPGException {
        ...
        else return new GnuPGData(data);
    }
    /**
     ...
     *         GnuPGData-Object
     */
    public GnuPGData createDataObject() throws GnuPGException { return new GnuPGData(); }
    /**
    ...
    public GnuPGKey[] generateEmptyKeyArray(int withLengthOf) {
        if (withLengthOf < 1) return null;
        else return new GnuPGKey[withLengthOf];
    }
    /**
     ...
     * @see com.freiheit.gnupg.GnuPGKey
     */
    public GnuPGKey[] listKeys() throws GnuPGException { return searchKeys(""); }
    /**
     ...
     * @see com.freiheit.gnupg.GnuPGKey
     */
    public GnuPGKey[] listSecretKeys() throws GnuPGException { return searchSecretKeys(""); }
    /**
    ...
    public String encryptToAscii(GnuPGKey[] recipients, GnuPGData plain) {
        ...
        cipher.destroy();
        if (previous == false) gpgmeSetArmor(l, false); // maintain the original ASCII-Armor state
        return ret;
    }
    /**
    ...
    public byte[] encryptToBinary(GnuPGKey[] recipients, GnuPGData plain) {
        ...
        try { cipher.write(out); } catch (IOException e) { e.printStackTrace(); }
        cipher.destroy();
        if (previous == false) gpgmeSetArmor(l, false); // maintain the original ASCII-Armor state
     ...
     * @see com.freiheit.gnupg.GnuPGKey
     */
    public GnuPGData encrypt(GnuPGKey[] recipients, byte[] plain) throws GnuPGException {
        if (hasNoRecipients(recipients) || plain == null || plain.length == 0) throw new GnuPGException("Encryption arguments not complete.");
    ...
    public GnuPGData encrypt(GnuPGKey[] recipients, String plain) throws GnuPGException {
        if (hasNoRecipients(recipients) || plain == null || plain.equals("")) throw new GnuPGException("Encryption arguments not complete.");
    ...
    public void encryptAndSign(GnuPGKey[] recipients, GnuPGData plain, GnuPGData cipher) throws GnuPGException {
        if (hasNoRecipients(recipients) || plain == null || cipher == null) throw new GnuPGException("Encryption-Arguments not complete.");
        gpgmeOpEncryptSign(this.getInternalRepresentation(), getInternalRepresentationFromRecipients(recipients), plain.getInternalRepresentation(), cipher.getInternalRepresentation());
    }
    /**
    ...
    public GnuPGData decrypt(byte[] cipher) throws GnuPGException {
        if (cipher == null || cipher.length == 0) throw new GnuPGException("Encryption arguments not complete.");

        GnuPGData plainData = createDataObject();
        final GnuPGData cipherData = createDataObject(cipher);

        gpgmeOpDecrypt(this.getInternalRepresentation(), cipherData.getInternalRepresentation(), plainData.getInternalRepresentation());
        cipherData.destroy();
        return plainData;
    }
    /**
    ...
    public void decrypt(GnuPGData cipher, GnuPGData plain) throws GnuPGException {
        ...
        gpgmeOpDecrypt(this.getInternalRepresentation(), cipher.getInternalRepresentation(), plain.getInternalRepresentation());
    }
    /**
    ...
    public void decryptVerify(GnuPGData cipher, GnuPGData plain) throws GnuPGException {
        if (cipher == null || plain == null) return;
        gpgmeOpDecryptVerify(this.getInternalRepresentation(), cipher.getInternalRepresentation(), plain.getInternalRepresentation());
    }
    ...
    public void sign(GnuPGData plain, GnuPGData signature) throws GnuPGException {
        ...
        gpgmeOpSign(this.getInternalRepresentation(), plain.getInternalRepresentation(), signature.getInternalRepresentation());
    }
    /**
    ...
    public void verify(GnuPGData signature, GnuPGData signed, GnuPGData plain) throws GnuPGException {
        ...
        gpgmeOpVerify(this.getInternalRepresentation(), signature.getInternalRepresentation(), signed.getInternalRepresentation(), plain.getInternalRepresentation());
    }
    /**
     ...
     */
    public void clearSigners() throws GnuPGException { gpgmeClearSigners(getInternalRepresentation());}
    /**
     ...
     * @see com.freiheit.gnupg.GnuPGKey
     */
    public GnuPGKey getSigner(int index) throws GnuPGException { return new GnuPGKey(gpgmeGetSigner(getInternalRepresentation(), index)); }
    /**
     ...
     * @see com.freiheit.gnupg.GnuPGKey
     */
    public long getSignersLength() throws GnuPGException { return gpgmeGetSignersLength(getInternalRepresentation()); }
    /**
     * Imports a Key (private or public). You can supply the key in ASCII armor.
     */
    public void importKey(GnuPGData keydata) throws GnuPGException { gpgmeOpImport(getInternalRepresentation(), keydata.getInternalRepresentation());}
    /**
     * Imports a Key (private or public). You can supply the key in ASCII armor.
     */
     ...
     */
    public void genPgpKey(String params) throws GnuPGException { gpgmeOpGenKey(getInternalRepresentation(), params); }
    /**
     * Generates a new Key.
     */
    public void genKey(String params, GnuPGData pub, GnuPGData secret) throws GnuPGException { gpgmeOpGenKey(getInternalRepresentation(), params); }
    /**
     ...
     */
    public GnuPGGenkeyResult getGenkeyResult() { return gpgmeOpGenkeyResult(getInternalRepresentation()); }
    /**
     ...
     */
    public void export(String pattern, long reserved, GnuPGData data) { gpgmeOpExport(getInternalRepresentation(), pattern, 0, data.getInternalRepresentation()); }
    /**
     ...
     */
    public void delete(GnuPGKey key, boolean allowSecret) { gpgmeOpDelete(getInternalRepresentation(), key.getInternalRepresentation(), allowSecret); }
    /*
